        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          delay: 0.2
            ...
            <div className="aspect-[4/3] rounded-lg overflow-hidden shadow-2xl">
              <img className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" alt="Gourmet steak dish with vegetables" src="https://horizons-cdn.hostinger.com/b326f609-ccc2-439f-af74-7c154119f498/liubov-ilchuk-_qzowg2oaj4-unsplash-19MDs.jpg" />
            </div>
          </motion.div>
        </div>
      </div>
