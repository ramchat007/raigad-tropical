    ...
    return n2 = this.authResponse(n2), i2 && this.isSuperusers && function registerAutoRefresh(e3, t3, s3, i3) {
      ...
      e3._resetAutoRefresh = function() {
        ...
        if ((_a = o2.query) == null ? void 0 : _a.autoRefresh)
          return n3 ? n3(r3, o2) : { url: r3, sendOptions: o2 };
...
var BatchService = class extends BaseService {
  ...
  async send(e2) {
    ...
    for (let e3 = 0; e3 < this.requests.length; e3++) {
      ...
      if (s2.push({ method: i2.method, url: i2.url, headers: i2.headers, body: i2.json }), i2.files)
  ...
  async send(e2, t2) {
    ...
    return (t2.fetch || fetch)(s2, t2).then(async (e3) => {
      ...
      try {
        ...
        if (((_a = t2.signal) == null ? void 0 : _a.aborted) || "AbortError" == (e4 == null ? void 0 : e4.name) || "Aborted" == (e4 == null ? void 0 : e4.message))
          throw e4;
      }
